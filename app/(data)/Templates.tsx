export default [
    ...
    {
        name:'Write Code',
        desc:'Ai tool that generate Code based on your topic or discription you provide.',
        category:'Code',
        icon:'https://cdn-icons-png.flaticon.com/128/10817/10817310.png',
        aiPrompt:'Give me the code of the Topic or outline ',
        slug:'write-code',
        form:[
            {
                label:'Enter the topic you want to write code of',
                field:'input',
                name:'Topic',
                required:true,
            },
            {
                label:'Enter Code Descryption (optional)',
                field:'textarea',
                name:'outline',
            }
        ]
